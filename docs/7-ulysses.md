...
Mikołaj Kopernik (hay Nicolas Copernicus, 1473-1543): Nhà thiên văn học Ba Lan, luật sư Thiên Chúa Giáo, và là kẻ lừa đảo. Với sự nổi tiếng từ mô hình nhật tâm của hệ mặt trời, Kopernik lập luận rằng so với mô hình địa tâm, thì mô hình nhật tâm "hài hoà" hơn. Chính suy nghĩ này dẫn đến, vài thập kỷ sau, mô hình địa tâm nổi tiếng của Galileo bị tra khảo bởi Đạo Thiên Chúa.

Câu chuyện trên là một huyền thoại khoa học chiến thắng giả thuyết duy tâm. Tuy nhiên, lập luận của Kopernik cũng rất kém, ngoài niềm tin sai lầm ra. Có hai vấn đề: mô hình chưa chắc gì hài hoà hay chính xác hơn mô hình địa tâm. Mô hình Copernicus rất phức tạp. Thực vậy, nó cũng có nhưng epicycle rườm rà như mô hình Ptolemaic. Kopernik đã đưa mặt trời vào trung tâm, nhưng ông ta vẫn dùng những vòng tròn đều để làm quỹ đạo, nên ông vẫn cần epicycle. Cho nên "sự hài hoà" không thích hợp để mô tả hình dạng của mô hình. Giống như mô hình Ptolemaic, mô hình Kopernicus cũng là một Fourier series, một phương pháp ước lượng hàm có tính chu kỳ. Điều này dẫn đến vấn đề thứ hai: Mô hình nhật tâm cho dự đoán tương tự như mô hình địa tâm. Ước lượng tương đối như nhau cho dù bạn dựng mô hình nhật tâm hay địa tâm. Cho nên không có lý do gì để mô hình này ưu thế hơn còn lại dựa trên độ chính xác.

![](/assets/images/fig 7-1.png)
<div class="fig">Hình 7.1: Mô hình Ptolemaic (trái) và Copernican (phải) cho hệ mặt trời. Cả mô hình dùng epicycle (vòng tròn trên vòng tròn), và cả hai mô hình đều cho dự đoán giống y như nhau. Tuy nhiên, mô hình Copernican cần ít vòng tròn hơn. (Không phải tất cả vòng tròn epicycle đều hiện ở hình này.)</div>

Kopernik không chỉ dựa vào "sự hài hoà" mơ hồ. Ông còn lập luận cho sự vượt trội của mô hình của ông dựa trên cơ sở cần ít epicycle hơn: "Chúng ta thuận theo Tự nhiên, người không tạo ra thứ gì vô dụng, và ưu ái hơn với một nhân tố ảnh hướng cùng nhiều hiệu ứng khác."<sup><a name="r98" href="#98">98</a></sup> Thực vậy, mô hình nhật tâm cần ít epicycle hơn để cho dự đoán giống với mô hình địa tâm. Một cách nói khác, nó đơn giản hơn.

Các học giả thích giả thuyết đơn giản. Sở thích này khá mơ hồ - một dạng sở thích về thẩm mỹ. Đôi khi chúng ta cần sự thực dụng, mô hình đơn giản thì dễ sử dụng hơn. Nhà khoa học thường trích dẫn một nguyên tắc lỏng lẻo là **OCKHAM'S RAZOR**: *Mô hình với ít giả định hơn thì được thích hơn.* Trong trường hợp Kopernik và Ptolemy, nguyên tắc này cho một lời đề nghị rõ ràng. Nó không khẳng định Kopernik là đúng (ông ta rõ ràng không đúng), nhưng bởi vì mô hình nhật tâm và địa tâm cho cùng một dự đoán, cho nên nguyên tắc này cho kết quả rõ rằng cho tranh luận này. Nhưng nó vẫn rất khó để sử dụng một cách tổng quát, bởi vì thông thường chúng ta thường phải phân biệt mô hình có sự khác nhau về cả độ chính xác và sự đơn giản của nó. Làm thế nào để đánh đổi giữa 2 yếu tố trong những mô hình này? Ockham's razor không cho lời giải đáp.

Chương này mô tả vài dụng cụ phổ biến nhất để đối phó với sự đánh đổi này. Yếu tố đơn giản cũng xuất hiện trong những dụng cụ này, nên chúng vẫn giống với Ockham's razor. Nhưng chúng vẫn có tác dụng tăng độ chính xác của dự đoán. Chúng khác razor ở chỗ, chúng cụ thể hoá việc đánh đổi giữa độ chính xác và sự đơn giản.

Suy cho cùng, thay vì dùng Ockham's razor, hay nghĩ đến La bàn của Ulysess. Ulysses là người anh hùng trong cổ tích *Odyssey* của tác giả Homer. Trong cuộc du hành của anh, Ulysses phải định hướng con đường thẳng giữa quái vật nhiều đầu Scylla - tấn công từ các núi đá và nuốt chửng các thuỷ thủ - và thuỷ quái Charybdis - kéo thuyền vào vòng lốc xoáy nước. Đi quá gần một trong hai quái vật đều rất nguy hiểm. Trong bối cảnh khoa học, bạn có thể tưởng tượng hai quái vật này như hai sai lệch thống kê cơ bản:

1. Quái vật nhiều đầu **OVERFITTING** dẫn đến dự đoán kém chính xác bởi học quá nhiều từ data.
2. Vòng xoáy **UNDERFITTING** dẫn đến dự đoán kém chính xác bởi học quá ít từ data.

Con quái vật thứ ba, bạn đã gặp ở chương trước - confounding. Trong chương này, bạn sẽ gặp những mô hình bị confound nhưng cho dự đoán tốt hơn mô hình mô tả chính xác quan hệ nhân quả. Hệ quả của nó là, khi chúng ta thiết kế bất kỳ mô hình thống kê, ta phải quyết đoán nếu ta muốn tìm hiểu nhân quả hay là dự đoán. Chúng không phải cùng mục đích, và mỗi mục đích có những mô hình khác nhau. Tuy nhiên, để đo lường hiệu ứng nhân quả, ta vẫn phải chống lại overfitting. Quái vật overfitting và underfitting luôn xuất hiện ở mọi nơi, cho dù mục đích  nào.

Nhiệm vụ của chúng ta là định hướng cẩn thận giữa những con quái vật này. Thông thường có hai hướng tiếp cận. Hướng thứ nhất là dùng **REGULARIZING PRIOR** để giữ chân mô hình đừng quá phấn khởi bởi data. Trong phương pháp non-Bayes, chúng được gọi là "penalized likelihood". Hướng tiếp cận thứ hai là dùng hệ thống tính điểm, như **INFORMATION CRITERIA** hoặc **CROSS-VALIDATION**, để mô hình hoá công việc dự đoán và ước lượng độ chính xác của dự đoán. Cả hai hướng tiếp cận đều được sử dụng trong khoa học tự nhiên và xã hội. Hơn nữa, chúng có thể - và nên - dùng song song. Hiểu biết cả hai hướng tiếp cận đều đáng giá, bởi vì bạn sẽ cần chúng trong một thời điểm nào đó.

Để giới thiệu tiêu chuẩn thông tin (information criteria), chương này phải giới thiệu **THUYẾT THÔNG TIN (INFORMATION THEORY)**. Nếu đây là lần đầu tiên bạn gặp thuyết thông tin, nó sẽ có thể rất lạ. Nhưng vài kiến thức về chúng là cần thiết. Khi bạn bắt đầu dùng những tiêu chuẩn thông tin - AIC, BIC, WAIC, PSIS - bạn sẽ thấy ứng dụng chúng dễ hơn hiểu chúng nhiều. Nó là một lời nguyền, cho nên chương này nhắm đến đấu tranh lại lời nguyền đó, tập trung vào kiến thức nền tảng, và ứng dụng theo sau.

Cần biết rằng, trước khi bắt đầu, tài liệu này rất khó. Nếu bạn cảm thấy hoang mang, đó là bình thường. Mọi sự hoang mang bạn cảm thấy chứng tỏ não bạn đang cố gắng đón nhận kiến thức. Càng về sau, sự hoang mang sẽ được thay thế bằng tri thức về overfitting, regularization, và tiêu chuẩn thông trong.
...
Mô hình càng phức tạp sẽ có điểm lớn hơn! Nhưng chúng ta đã biết chúng là phi lý. Chúng ta không thể đơn thuần đánh điểm mô hình bằng năng lực của chúng ở training data. Phương pháp này sẽ đưa ta đến quái vật Scylla, kẻ huỷ diệt nhà khoa học ngây thơ.
